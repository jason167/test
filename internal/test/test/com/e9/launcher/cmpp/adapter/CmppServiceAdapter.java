package test.com.e9.launcher.cmpp.adapter;
 ...
 */
public class CmppServiceAdapter implements ServiceAdapter {
	...
	public Message execute(Message message, Session session, MessageType messageType) {
		...
		System.out.println("CmppServiceAdapter.message:".concat(message.toString()));
		return null;
	}
