...
/**
 * Report应答命令，见SGIP 1.21版4.2.3.5.2章节
 * @date 2013-8-26
 * @author Jason
 */
public class SgipReportResp extends AbstractSgipMessage {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6784083562832361620L;
	/**
	 * <pre>
		Report命令是否成功接收。
		0：接收成功
	...
	public String toString() {
		return super.toString() + "SgipReportResp [result=" + result + ", reserve=" + reserve + "]";
	}
