...
/**
 * unbindy应答命令，见SGIP 1.21版4.2.3.2.2章节
 * @date 2013-8-24
 * @author Jason
 */
public class SgipUnbindResp extends AbstractSgipMessage {

	/**
	 * 
	 */
	private static final long serialVersionUID = -9173435754569733718L;
	...
	public SgipUnbindResp() {
		...
		setCommandId(SgipCommandId.UNBIND_RESP);
	}
	...
	public String toString() {
		return super.toString() + "SgipUnbindResp []";
	}
