...
/**
 * ActiveTest,见《中国电信CTMP开发接口－中国电信SMGP协议》 5.2.2.4.1章节
 * @project E9Framework
 * @date 2013-1-14
 * @version 1.0
 * @author Jason
 ...
 */
public class SmgpActiveTest extends AbstractMessage {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 8447575807665612815L;

	/**
	 * 
	 */
	public SmgpActiveTest() {
		// TODO Auto-generated constructor stub
		super.setCommandId(SmgpCommandId.ACTIVE_TEST);
	}
	...
	public String toString() {
		return super.toString() + "SmgpActiveTest []";
	}
