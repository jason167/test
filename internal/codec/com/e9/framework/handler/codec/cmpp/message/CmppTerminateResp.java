...
/**
 * TerminateResp,见CMPP v2.0 7.4.2.2章节
 * @project E9Framework
 * @date 2013-1-24
 * @version 1.0
 * @author Jason
 ...
 */
public class CmppTerminateResp extends AbstractMessage {
	/**
	 * 
	 */
	private static final long serialVersionUID = 3572369484332770850L;
	...
	public CmppTerminateResp() {
		...
		super.setCommandId(CmppCommandId.TERMINATE_RESP);
	}
	...
	public String toString() {
		return super.toString() + " TerminateResp []";
	}
