...
/**
 * 修改密码应答，见《短信通道协议开发包V3.06(内部使用)》3.2.5.10章节
 * @date 2013-9-2
 * @author Jason
 */
public class GwModifyPasswordResp extends AbstractGwMessage {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3094870635832298481L;
	 ...
	 * 
	 */
	public GwModifyPasswordResp() {
		// TODO Auto-generated constructor stub
		setCommandId(GwCommandId.MODIFY_PASSWORD_RESP);
		setSyncMessage(true);
	}
	/* (non-Javadoc)
	...
	public String toString() {
		return super.toString() + "GwModifyPasswordResp [status=0x" + Integer.toHexString(status) + "]";
	}
