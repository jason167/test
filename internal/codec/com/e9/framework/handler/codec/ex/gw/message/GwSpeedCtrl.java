...
/**
 * 速度控制，见《短信通道协议开发包V3.06(内部使用)》3.2.5.9章节
 * @date 2013-9-2
 * @author Jason
 */
public class GwSpeedCtrl extends AbstractGwMessage {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2494975940047960422L;
	/**
	 * 
	 */
	public GwSpeedCtrl() {
		// TODO Auto-generated constructor stub
		setCommandId(GwCommandId.SPEED_CTRL);
	}
	/**
	 * 发送速度，单位：条/秒
	 */
	...
	public void decode(IoBuffer arg0) throws Exception {
		...
		try {
			...
			setSpeed(readInt(buffer, GwLength.SPEED));
		} catch (Exception e) {
	...
	public void encode(IoBuffer arg0) throws Exception {
		...
		try {
			...
			writeInt(buffer, getSpeed(), GwLength.SPEED);
			endEncode(buffer);
		} catch (Exception e) {
			// TODO: handle exception
	...
	public String toString() {
		return super.toString() + "GwSpeedCtrl [speed=" + speed + "]";
	}
