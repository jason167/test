...
/**
 * 短信单发应答命令， 见《短信通道协议开发包V3.06(内部使用)》3.2.5.3章节
 * @date 2013-9-2
 * @author Jason
 */
public class GwSubmitResp extends AbstractGwMessage {

	/**
	 * 
	 */
	private static final long serialVersionUID = -536349673593068174L;
	...
	public GwSubmitResp() {
		...
		setCommandId(GwCommandId.SUBMIT_RESP);
	}
	...
	public String toString() {
		return super.toString() + "GwSubmitResp [reqID=" + reqID + ", agentID=" + agentID + ", status=" + status
				+ ", msg=" + msg + "]";
	}
