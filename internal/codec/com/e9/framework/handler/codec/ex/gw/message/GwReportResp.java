...
/**
 * 状态报告应答，见《短信通道协议开发包V3.06(内部使用)》3.2.5.5章节
 * @date 2013-9-2
 * @author Jason
 */
public class GwReportResp extends AbstractGwMessage {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7296297951791988803L;
	private int status = GwStatus.SEND_SUCCESSFUL.ordinal();
	...
	public GwReportResp() {
		...
		setCommandId(GwCommandId.REPORT_RESP);
	}
	...
	public String toString() {
		return super.toString() + "GwReportResp [status=0x" + Integer.toHexString(status) + "]";
	}
