 ...
 */
package com.e9.framework.logger.ex;
 ...
 */
public class E9FixedWindowRollingPolicy extends RollingPolicyBase {
  ...
  private FileNamePattern zipEntryFileNamePattern;
  /**
   * It's almost always a bad idea to have a large window size, say over 12.
   */
  private static int MAX_WINDOW_SIZE = Integer.MAX_VALUE;

  public E9FixedWindowRollingPolicy() {
    minIndex = 1;
    maxIndex = 7;
  }
